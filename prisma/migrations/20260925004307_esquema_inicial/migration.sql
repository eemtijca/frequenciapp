...
CREATE TABLE "atribuicoes" (
    ...
    CONSTRAINT "atribuicoes_pkey" PRIMARY KEY ("professor_id","turma_id")
);
...
-- CreateIndex
CREATE INDEX "atribuicoes_turma_id_idx" ON "atribuicoes"("turma_id");
...
-- AddForeignKey
ALTER TABLE "atribuicoes" ADD CONSTRAINT "atribuicoes_professor_id_fkey" FOREIGN KEY ("professor_id") REFERENCES "usuarios"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "atribuicoes" ADD CONSTRAINT "atribuicoes_turma_id_fkey" FOREIGN KEY ("turma_id") REFERENCES "turmas"("id") ON DELETE CASCADE ON UPDATE CASCADE;
