...
- Toda a superfície de erro fala a mesma língua: "Já existe um registro com este e-mail", "Este professor tem chamadas registradas e não pode ser excluído", "Não foi possível falar com o banco de dados. Tente novamente em instantes".
