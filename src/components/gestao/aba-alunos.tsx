  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="bg-secondary/60 text-secondary-foreground rounded-lg border px-4 py-3 text-xs leading-relaxed">
        Guardamos apenas o nome de frequencia e as turmas. Nenhum outro dado pessoal é necessário
        para a frequência. A exclusão apaga também o histórico de faltas do aluno; para retirá-lo da
        frequencia preservando o histórico, desative.
      </p>
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                placeholder="Nome de frequencia"
                className="h-11 rounded-lg"
              />
            </div>
            <div className="flex flex-col gap-2">
